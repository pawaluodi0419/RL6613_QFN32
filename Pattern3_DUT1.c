...
/*
	...
	case 0x0003:
	{
		...
		else
		{
			...
			vmon_1v_adc_code_high = (dut1.g_pattern_smbus_control_buf[10]<<2);
	...
	case 0x0004:
	{
		...
		{
			//xil_printf("dut1.g_pattern_smbus_control_buf[10] =%x\r\n", dut1.g_pattern_smbus_control_buf[10]);
			vmon_1v_adc_code_low = dut1.g_pattern_smbus_control_buf[10];
			vmon_1v_adc_code = (vmon_1v_adc_code_high | vmon_1v_adc_code_low) & 0x3ff;
			xil_printf("dut1 read_adc_count =%x   vmon_1v_adc_code =%x\r\n", read_adc_index, vmon_1v_adc_code);
			...
			if(read_adc_count == 0)
			{
				...
				dut1.g_uartPatternNum = (dut1.g_uartPatternNum++ & 0xff);
				result_output_for_v50(XPAR_AXI_GPIO_dut1_1_BASEADDR,dut1.g_uartPatternNum);
				xil_printf("dut1 vmon_1v_adc_code_average =%x\r\n", vmon_1v_adc_code_average);
