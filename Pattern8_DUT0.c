...
u8 _by_Pattern8_dut0()
{
	...
	case 0x0000:
	{
		if(dut0.g_dut_pattern_status_buf[7] == 0x00)
		{
			...
			xil_printf("dut0.pattern8_gpio_control_completed!\r\n");
			msdelay(10);
		}
	...
	case 0x0001:
	{
		...
		dut0.g_dac_data_buf[1] = 0xdc;	//Data L
		dut0.g_dac_data_buf[2] = 0x05;	//Data H
		dut0.g_dac_data_buf[3] = 0xa0;	//Data L
		dut0.g_dac_data_buf[4] = 0x05;	//Data H
		dut0.g_dac_data_buf[5] = 0x18;	//Data L
		dut0.g_dac_data_buf[6] = 0x06;	//Data H
	...
	case 0x0004:
	{
		...
		else
		{
			...
			if(dut0.g_pattern_smbus_control_buf[10] == 0x88)
			{
				for(i=1; i<31; i++)
				{
					dut0.g_pattern_smbus_control_buf[i] = CLEAR_;
	...
	{
		xil_printf("dut0.pattern8_fail! fail_step = %x\r\n",dut0.g_pattern_step);
