...
u8 _by_PatternA_dut3()
{
	...
	case 0x0000:
	{
		if(dut3.g_dut_pattern_status_buf[7] == 0x00)
		{
			...
			xil_printf("dut3.patternA_gpio_control_completed!\r\n");
			msdelay(10);
		}
	...
	case 0x0001:
	{
		...
		dut3.g_dac_data_buf[1] = 0xe8;	//Data L
		dut3.g_dac_data_buf[2] = 0x03;	//Data H
		dut3.g_dac_data_buf[3] = 0xac;	//Data L
		dut3.g_dac_data_buf[4] = 0x03;	//Data H
		dut3.g_dac_data_buf[5] = 0x24;	//Data L
	...
	case 0x0003:
	{
		...
		dut3.g_pattern_smbus_control_buf[5] = 0x0a;
	...
	case 0x0004:
	{
		...
		else
		{
			...
			if(dut3.g_pattern_smbus_control_buf[10] == 0x8A)
			{
				for(i=1; i<31; i++)
				{
					dut3.g_pattern_smbus_control_buf[i] = CLEAR_;
	...
	{
		xil_printf("dut3.patternA_fail! fail_step = %x\r\n",dut3.g_pattern_step);
