...
u8 _by_PatternB_dut3()
{
	...
	case 0x0000:
	{
		if(dut3.g_dut_pattern_status_buf[7] == 0x00)
		{
			...
			xil_printf("dut3.patternB_gpio_control_completed!\r\n");
			msdelay(10);
		}
	...
	case 0x0001:
	{
		...
		dut3.g_dac_data_buf[1] = 0x58;	//Data L
		dut3.g_dac_data_buf[2] = 0x02;	//Data H
		dut3.g_dac_data_buf[3] = 0x1c;	//Data L
		dut3.g_dac_data_buf[4] = 0x02;	//Data H
		dut3.g_dac_data_buf[5] = 0x94;	//Data L
		dut3.g_dac_data_buf[6] = 0x02;	//Data H
	...
	case 0x0004:
	{
		...
		else
		{
			...
			if(dut3.g_pattern_smbus_control_buf[10] == 0x8B)
			{
				for(i=1; i<31; i++)
				{
					dut3.g_pattern_smbus_control_buf[i] = CLEAR_;
	...
	{
		xil_printf("dut3.patternB_fail! fail_step = %x\r\n",dut3.g_pattern_step);
