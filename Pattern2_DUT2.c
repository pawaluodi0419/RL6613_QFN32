...
u8 _by_Pattern2_dut2()
{
	...
	case 0x0000:
	{
		if(dut2.g_dut_pattern_status_buf[7] == 0x00)
		{
			...
			xil_printf("dut2.pattern2_gpio_control_completed!\r\n");
			msdelay(10);
		}
	...
	case 0x0001:
	{
		...
		dut2.g_pattern_smbus_control_buf[5] = 0x02;
	...
	case 0x0002:
	{
		...
		else
		{
			...
			//msdelay(10);
			if(dut2.g_pattern_smbus_control_buf[10] == 0x82)
			{
				for(i=1; i<31; i++)
				{
					dut2.g_pattern_smbus_control_buf[i] = CLEAR_;
	...
	{
		xil_printf("dut2.pattern2_fail! fail_step = %x\r\n",dut2.g_pattern_step);
