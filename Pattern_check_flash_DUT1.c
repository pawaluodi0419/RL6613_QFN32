...
u8 _by_Pattern_check_flash_dut1()
{
	u8 i;
	...
	case 0x0000:
	{
		...
		{
			Buff_dut1_XGPIO_0[0] = 0x01;                            //REG0005 ouput value[7:0]
			...
			Buff_dut1_XGPIO_0[7] = 0xF4;							//REG000c
			...
			//xil_printf("dut1.pattern_check_flash_gpio_control_completed!\r\n\r\n");
			msdelay(10);
		}
	...
	case 0x0001:
	{
		dut1.g_pattern_smbus_control_buf[1] = smbus_cmd_type_reset_to_rom;
		dut1.g_pattern_smbus_control_buf[2] = 0xda;
		dut1.g_pattern_smbus_control_buf[3] = 0x0b;
		dut1.g_pattern_smbus_control_buf[4] = 0x00;
	...
	case 0x0002:
	{
		...
		else
		{
			...
			{
				xil_printf("dut1 check in rom code pass!\r\n\r\n");
				dut1.g_pattern_step++;
			}
			else
			{
	...
	case 0x0003:
	{
		...
		dut1.g_pattern_smbus_control_buf[3] = 0xd0;
		dut1.g_pattern_smbus_control_buf[4] = 0x01;
		dut1.g_pattern_smbus_control_buf[5] = 0x01;
	...
	case 0x0004:
	{
		dut1.g_pattern_smbus_control_buf[1] = smbus_cmd_type_writeflash;
		dut1.g_pattern_smbus_control_buf[2] = 0x00;
		dut1.g_pattern_smbus_control_buf[3] = 0x01;
		dut1.g_pattern_smbus_control_buf[4] = 0x08;

		dut1.g_pattern_smbus_control_buf[5] = 0x55;
		dut1.g_pattern_smbus_control_buf[6] = 0xaa;
		dut1.g_pattern_smbus_control_buf[7] = 0xaa;
		dut1.g_pattern_smbus_control_buf[8] = 0x55;
		dut1.g_pattern_smbus_control_buf[9] = 0x00;
		dut1.g_pattern_smbus_control_buf[10] = 0xff;
		dut1.g_pattern_smbus_control_buf[11] = 0xff;
		dut1.g_pattern_smbus_control_buf[12] = 0x00;
	...
	{
		dut1.g_pattern_smbus_control_buf[1] = smbus_cmd_type_writeflash;
		dut1.g_pattern_smbus_control_buf[2] = 0x10;
		dut1.g_pattern_smbus_control_buf[3] = 0x01;
		dut1.g_pattern_smbus_control_buf[4] = 0x08;
	...
	{
		dut1.g_pattern_smbus_control_buf[1] = smbus_cmd_type_writeflash;
		dut1.g_pattern_smbus_control_buf[2] = 0x18;
		dut1.g_pattern_smbus_control_buf[3] = 0x01;
		dut1.g_pattern_smbus_control_buf[4] = 0x08;
		...
		{
			xil_printf("dut1 flash data write pass!\r\n\r\n");
			for(i=1; i<60; i++)
			{
				dut1.g_pattern_smbus_control_buf[i] = CLEAR_;
			}
	...
	case 0x0008:
	{
		dut1.g_pattern_smbus_control_buf[1] = smbus_cmd_type_readflash;
		dut1.g_pattern_smbus_control_buf[2] = 0x00;
		dut1.g_pattern_smbus_control_buf[3] = 0x01;
		dut1.g_pattern_smbus_control_buf[4] = 0x20;
		...
		else
		{
			for(i=0;i<32;i++)
			{
				read_flashdata[i] = dut1.g_pattern_smbus_control_buf[i+10];
			}
			for(i=0;i<32;i++)
			{
				//xil_printf("dut1.read_flashdata[%02d]= %02x\r\n", i, read_flashdata[i]);
			}
			...
			{
				xil_printf("dut1 compare flash data pass!\r\n\r\n");
				dut1.g_pattern_step++;
			}
			else
			{
	...
	case 0x0009:
	{
		dut1.g_pattern_smbus_control_buf[1] = smbus_cmd_type_eraseflash;
		dut1.g_pattern_smbus_control_buf[2] = 0xda;
		dut1.g_pattern_smbus_control_buf[3] = 0x0b;
		dut1.g_pattern_smbus_control_buf[4] = 0x00;
		...
		{
			xil_printf("dut1 erase flash data pass!\r\n\r\n");
			for(i=1; i<60; i++)
			{
				dut1.g_pattern_smbus_control_buf[i] = CLEAR_;
			}
	...
	case 0x000a:
	{
		...
		else
		{
			...
			{
				xil_printf("dut1 check flash data all 0xff pass!\r\n");
				dut1.g_pattern_step++;
			}
			else
			{
	...
	case 0x000b:
	{
		...
		xil_printf("dut1.FT2_pass!\r\n\r\n");
		PASS_COUNT++;
		xil_printf(">>>>>>>>>>>>>>>>>>>> DUT1 PASS_COUNT = %d\r\n\r\n", PASS_COUNT);
	...
	{
		xil_printf("dut1.pattern_check_flash_fail! fail_step = %x\r\n\r\n",dut1.g_pattern_step);
		pattern_safe_state_dut1();
	}
