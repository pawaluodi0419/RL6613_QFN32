...
u8 _ccdet_calibration_dut1()
{
	...
	case ccdet_process_doing:
	{
		...
		case 0x0001:
		{
		   ...
		   dut1.g_pattern_smbus_control_buf[5] = 0x88;
		...
		{
	       dut1.g_pattern_smbus_control_buf[1] = smbus_cmd_type_writemem;
		   dut1.g_pattern_smbus_control_buf[2] = 0xa2;
		   dut1.g_pattern_smbus_control_buf[3] = 0xc1;
		   dut1.g_pattern_smbus_control_buf[4] = 0x01;
		   dut1.g_pattern_smbus_control_buf[5] = 0x06;
		...
		{
	       dut1.g_pattern_smbus_control_buf[1] = smbus_cmd_type_writemem;
		   dut1.g_pattern_smbus_control_buf[2] = 0xa3;
		   dut1.g_pattern_smbus_control_buf[3] = 0xc1;
		   dut1.g_pattern_smbus_control_buf[4] = 0x01;
		   dut1.g_pattern_smbus_control_buf[5] = 0x06;
		...
		{
	       dut1.g_pattern_smbus_control_buf[1] = smbus_cmd_type_writemem;
		   dut1.g_pattern_smbus_control_buf[2] = 0xae;
		   dut1.g_pattern_smbus_control_buf[3] = 0xc1;
		   dut1.g_pattern_smbus_control_buf[4] = 0x01;
		...
		{
	       dut1.g_pattern_smbus_control_buf[1] = smbus_cmd_type_writemem;
		   dut1.g_pattern_smbus_control_buf[2] = 0xa0;
		   dut1.g_pattern_smbus_control_buf[3] = 0xc1;
		   dut1.g_pattern_smbus_control_buf[4] = 0x01;
		...
		case 0x0006:
		{
			...
			//xil_printf("dut1_pattern5_write_0x109/0x10a/0x10b/0x10c_default_dataL= %x\r\n",dut1.g_ccdet_calibration_data_buf[0]);
			//xil_printf("dut1_pattern5_write_0x109/0x10a/0x10b/0x10c_default_dataH= %x\r\n",dut1.g_ccdet_calibration_data_buf[1]);
			//xil_printf("dut1.g_pattern_step = %x\r\n",dut1.g_pattern_step);
		    break;
		}
		...
		case 0x0007:
		{
			...
			dut1.g_pattern_smbus_control_buf[2] = 0xa9;
			dut1.g_pattern_smbus_control_buf[3] = 0xc1;
			dut1.g_pattern_smbus_control_buf[4] = 0x01;
