...
u8 _by_PatternD_dut2()
{
	...
	case 0x0000:
	{
		...
		xil_printf("dut2.patternD_gpio_control_completed!\r\n");
		msdelay(10);
	...
	******************************************/
	...
	case 0x0001:
	{
		...
		dut2.g_dac_data_buf[2] = 0x01;	//0x0190换算成十进制为400, 400/2000 = 0.2
		dut2.g_dac_data_buf[3] = 0x68;
		dut2.g_dac_data_buf[4] = 0x01;	//0x0168换算成十进制为360, 360/2000 = 0.18
		dut2.g_dac_data_buf[5] = 0xb8;
		dut2.g_dac_data_buf[6] = 0x01;	//0x01b8换算成十进制为440, 440/2000 = 0.22

		dut2.g_ccdet_phy_calibration_addr_buf[0] = 0x09;
		dut2.g_ccdet_phy_calibration_addr_buf[1] = 0x01;
		dut2.g_ccdet_voltage_sel = 0x44;
		...
		else
		{
			...
			xil_printf("dut2_CC1_0.2V_Calibration pass!\r\n");
			msdelay(5);
		}
		break;
	}
	...
	case 0x0002:
	{
		...
		dut2.g_dac_data_buf[2] = 0x03;	//0x0320换算成十进制为800, 800/2000 = 0.4
		dut2.g_dac_data_buf[3] = 0xe4;
		dut2.g_dac_data_buf[4] = 0x02;	//0x02e4换算成十进制为740, 740/2000 = 0.37
		dut2.g_dac_data_buf[5] = 0x5c;
		dut2.g_dac_data_buf[6] = 0x03;	//0x035c换算成十进制为2460, 860/2000 = 0.43
		...
		else
		{
			...
			dut2.g_pattern_step = 0;
			//xil_printf("dut2.g_ccdet_step = %x\r\n",dut2.g_ccdet_step);
			xil_printf("dut2_CC1_0.4V_Calibration pass!\r\n");
			msdelay(5);
		}
		break;
	}
	...
	case 0x0003:
	{
		...
		dut2.g_dac_data_buf[1] = 0x28;	//Data L
		dut2.g_dac_data_buf[2] = 0x05;	//Data H	0x0528换算成十进制为1320, 1320/2000 = 0.66
		dut2.g_dac_data_buf[3] = 0x00;	//Data L
		dut2.g_dac_data_buf[4] = 0x05;	//Data H	0x0500换算成十进制为1280, 1280/2000 = 0.64
		dut2.g_dac_data_buf[5] = 0x50;	//Data L
		dut2.g_dac_data_buf[6] = 0x05;	//Data H	0x0550换算成十进制为1360, 1280/2000 = 0.68
		...
		else
		{
			...
			dut2.g_pattern_step = 0;
			//xil_printf("dut2.g_ccdet_step = %x\r\n",dut2.g_ccdet_step);
			xil_printf("dut2_CC1_0.66V_Calibration pass!\r\n");
			msdelay(5);
		}
		break;
	}
	...
	case 0x0004:
	{
		...
		dut2.g_dac_data_buf[2] = 0x06;	//0x0640换算成十进制为1600, 1600/2000 = 0.8
		dut2.g_dac_data_buf[3] = 0x04;
		dut2.g_dac_data_buf[4] = 0x06;	//0x0604换算成十进制为1540, 1540/2000 = 0.77
		dut2.g_dac_data_buf[5] = 0x08;
		dut2.g_dac_data_buf[6] = 0x07;	//0x0708换算成十进制为1800, 1800/2000 = 0.9
		...
		else
		{
			...
			dut2.g_pattern_step = 0;
			//xil_printf("dut2.g_ccdet_step = %x\r\n",dut2.g_ccdet_step);
			xil_printf("dut2_CC1_0.8V_Calibration pass!\r\n");
			msdelay(5);
		}
		break;
	}
	...
	case 0x0005:
	{
		...
		dut2.g_dac_data_buf[2] = 0x09;	//0x099c换算成十进制为2460, 2460/2000 = 1.23
		dut2.g_dac_data_buf[3] = 0x60;
		dut2.g_dac_data_buf[4] = 0x09;	//0x0960换算成十进制为2400, 2400/2000 = 1.2
		dut2.g_dac_data_buf[5] = 0xd8;
		dut2.g_dac_data_buf[6] = 0x09;	//0x09d8换算成十进制为2520, 2520/2000 = 1.26

		dut2.g_ccdet_phy_calibration_addr_buf[0] = 0x0a;
		dut2.g_ccdet_phy_calibration_addr_buf[1] = 0x01;
		dut2.g_ccdet_voltage_sel = 0x00;
		...
		//xil_printf("dut2_pattern5_CC1_1.23V_Calibration_before\r\n");
		_ccdet_calibration_dut2();
		if(dut2.g_ccdet_process_bit != ccdet_process_done_pass)
		{
		...
		else
		{
			...
			dut2.g_pattern_step = 0;
			//xil_printf("dut2.g_ccdet_step = %x\r\n",dut2.g_ccdet_step);
			xil_printf("dut2_CC1_1.23V_Calibration pass!\r\n");
			msdelay(5);
		}
		break;
	}
	...
	case 0x0006:
	{
		...
		dut2.g_dac_data_buf[2] = 0x0c;	//0x0c80换算成十进制为3200, 3200/2000 = 1.6
		dut2.g_dac_data_buf[3] = 0x1c;
		dut2.g_dac_data_buf[4] = 0x0c;	//0x0c1c换算成十进制为2460, 3100/2000 = 1.55
		dut2.g_dac_data_buf[5] = 0xbc;
		dut2.g_dac_data_buf[6] = 0x0c;	//0x0cbc换算成十进制为2460, 3260/2000 = 1.63
		...
		else
		{
			...
			dut2.g_pattern_step = 0;
			//xil_printf("dut2.g_ccdet_step = %x\r\n",dut2.g_ccdet_step);
			xil_printf("dut2_CC1_1.6V_Calibration pass!\r\n");
			msdelay(5);
		}
		break;
	}
	...
	case 0x0007:
	{
		...
		dut2.g_dac_data_buf[2] = 0x0a;	//0x0a28换算成十进制为2600, 2600/1000 = 2.6
		dut2.g_dac_data_buf[3] = 0xa6;
		dut2.g_dac_data_buf[4] = 0x09;	//0x09a6换算成十进制为2470, 2460/1000 = 2.47
		dut2.g_dac_data_buf[5] = 0xaa;
		dut2.g_dac_data_buf[6] = 0x0a;	//0x0aaa换算成十进制为2730, 2730/1000 = 2.73
		...
		else
		{
			...
			dut2.g_pattern_step = 0;
			//xil_printf("dut2.g_ccdet_step = %x\r\n",dut2.g_ccdet_step);
			xil_printf("dut2_CC1_2.6V_Calibration pass!\r\n");
			msdelay(5);
		}
		break;
	}
	...
	case 0x0008:
	{
		...
		dut2.g_ccdet_phy_calibration_addr_buf[0] = 0x0b;
		dut2.g_ccdet_phy_calibration_addr_buf[1] = 0x01;
		dut2.g_ccdet_voltage_sel = 0x44;
		...
		else
		{
			...
			dut2.g_pattern_step = 0;
			xil_printf("dut2.g_ccdet_step = %x\r\n",dut2.g_ccdet_step);
			xil_printf("dut2_CC2_0.2V_Calibration pass!\r\n");
			msdelay(5);
		}
		break;
	}
	...
	case 0x0009:
	{
		...
		else
		{
			...
			dut2.g_pattern_step = 0;
			//xil_printf("dut2.g_ccdet_step = %x\r\n",dut2.g_ccdet_step);
			xil_printf("dut2_CC2_0.4V_Calibration pass!\r\n");
			msdelay(5);
		}
		break;
	}
	...
	case 0x000a:
	{
		...
		else
		{
			...
			dut2.g_pattern_step = 0;
			//xil_printf("dut2.g_ccdet_step = %x\r\n",dut2.g_ccdet_step);
			xil_printf("dut2_CC2_0.66V_Calibration pass!\r\n");
			msdelay(5);
		}
		break;
	}
	...
	case 0x000b:
	{
		...
		else
		{
			...
			dut2.g_pattern_step = 0;
			//xil_printf("dut2.g_ccdet_step = %x\r\n",dut2.g_ccdet_step);
			xil_printf("dut2_CC2_0.8V_Calibration pass!\r\n");
			msdelay(5);
		}
		break;
	}
	...
	case 0x000c:
	{
		...
		dut2.g_ccdet_phy_calibration_addr_buf[0] = 0x0c;
		dut2.g_ccdet_phy_calibration_addr_buf[1] = 0x01;
		dut2.g_ccdet_voltage_sel = 0x00;
		...
		else
		{
			...
			dut2.g_pattern_step = 0;
			//xil_printf("dut2.g_ccdet_step = %x\r\n",dut2.g_ccdet_step);
			xil_printf("dut2_CC2_1.23V_Calibration pass!\r\n");
			msdelay(5);
		}
		break;
	}
	...
	case 0x000d:
	{
		...
		else
		{
			...
			dut2.g_pattern_step = 0;
			//xil_printf("dut2.g_ccdet_step = %x\r\n",dut2.g_ccdet_step);
			xil_printf("dut2_CC2_1.6V_Calibration pass!\r\n");
			msdelay(5);
		}
		break;
	}
	...
	case 0x00e:
	{
		...
		else
		{
			...
			dut2.g_ccdet_retest_signbit = 0;
			//dut2.g_ccdet_step++;
			dut2.g_ccdet_step = 0x16;
			dut2.g_pattern_step = 0;
			//xil_printf("dut2.g_ccdet_step = %x\r\n",dut2.g_ccdet_step);
			xil_printf("dut2_CC2_2.6V_Calibration pass!\r\n");
      		xil_printf("dut2_patternD_pass!\r\n\r\n");
		}
		break;
	}
/*
	...
	case 0x000f:
	{
		cc_compare_temp_buf[0] = (dut2.g_ccdet_calibration_data_buf[4]) & 0x0f;			//cc1 0.8v
		cc_compare_temp_buf[1] = (dut2.g_ccdet_calibration_data_buf[4] >> 4) & 0x0f;	//cc1 0.66v

		cc_compare_temp_buf[2] = (dut2.g_ccdet_calibration_data_buf[5]) & 0x0f;			//cc1 0.4v
		cc_compare_temp_buf[3] = (dut2.g_ccdet_calibration_data_buf[5] >> 4) & 0x0f;	//cc1 0.2v

		//cc_compare_temp_buf[4] = (dut2.g_ccdet_calibration_data_buf[6]) & 0x0f;
		cc_compare_temp_buf[5] = (dut2.g_ccdet_calibration_data_buf[6] >> 4) & 0x0f;	//cc1 2.6v

		cc_compare_temp_buf[6] = (dut2.g_ccdet_calibration_data_buf[7]) & 0x0f;			//cc1 1.6v
		cc_compare_temp_buf[7] = (dut2.g_ccdet_calibration_data_buf[7] >> 4) & 0x0f;	//cc1 1.23v

		cc_compare_temp_buf[8] = (dut2.g_ccdet_calibration_data_buf[8]) & 0x0f;			//cc2 0.8v
		cc_compare_temp_buf[9] = (dut2.g_ccdet_calibration_data_buf[8] >> 4) & 0x0f;	//cc2 0.66v

		cc_compare_temp_buf[10] = (dut2.g_ccdet_calibration_data_buf[9]) & 0x0f;		//cc2 0.4v
		cc_compare_temp_buf[11] = (dut2.g_ccdet_calibration_data_buf[9] >> 4) & 0x0f;	//cc2 0.2v

		//cc_compare_temp_buf[12] = (dut2.g_ccdet_calibration_data_buf[10]) & 0x0f;
		cc_compare_temp_buf[13] = (dut2.g_ccdet_calibration_data_buf[10] >> 4) & 0x0f;	//cc2 2.6v

		cc_compare_temp_buf[14] = (dut2.g_ccdet_calibration_data_buf[11]) & 0x0f;		//cc2 1.6v
		cc_compare_temp_buf[15] = (dut2.g_ccdet_calibration_data_buf[11] >> 4) & 0x0f;	//cc2 1.23v
...
*/
	...
	case 0x0016:
	{
		...
		dut2.g_pattern_smbus_control_buf[2] = 0x3c;
		dut2.g_pattern_smbus_control_buf[3] = 0xdf;
		dut2.g_pattern_smbus_control_buf[4] = 0x01;
		dut2.g_pattern_smbus_control_buf[5] = 0x10;
	...
	{
		xil_printf("dut2_patternD_fail! patternD_fail_step = %x ccdet_calib_step = %x\r\n",dut2.g_pattern_step,dut2.g_ccdet_step);
