...
u8 _by_Pattern9_dut0()
{
	...
	case 0x0000:
	{
		if(dut0.g_dut_pattern_status_buf[7] == 0x00)
		{
			...
			xil_printf("dut0.pattern9_gpio_control_completed!\r\n");
			msdelay(10);
		}
	...
	case 0x0001:
	{
		...
		dut0.g_dac_data_buf[1] = 0x4c;	//Data L
		dut0.g_dac_data_buf[2] = 0x04;	//Data H
		dut0.g_dac_data_buf[3] = 0x10;	//Data L
		dut0.g_dac_data_buf[4] = 0x04;	//Data H
		dut0.g_dac_data_buf[5] = 0x88;	//Data L
	...
	case 0x0003:
	{
		...
		dut0.g_pattern_smbus_control_buf[5] = 0x09;
	...
	case 0x0004:
	{
		...
		else
		{
			...
			if(dut0.g_pattern_smbus_control_buf[10] == 0x89)
			{
				for(i=1; i<31; i++)
				{
					dut0.g_pattern_smbus_control_buf[i] = CLEAR_;
	...
	{
		xil_printf("dut0.pattern9_fail! fail_step = %x\r\n",dut0.g_pattern_step);
