...
u8 _by_Pattern7_dut0()
{
	...
	case 0x0000:
	{
		...
		dut0.g_pattern_smbus_control_buf[5] = 0x07;
	...
	case 0x0001:
	{
		...
		else
		{
			...
			if(dut0.g_pattern_smbus_control_buf[10] == 0x87)
			{
				for(i=1; i<31; i++)
				{
					dut0.g_pattern_smbus_control_buf[i] = CLEAR_;
	...
	{
		xil_printf("dut0.pattern7_fail! fail_step = %x\r\n",dut0.g_pattern_step);
