...
u8 _by_PatternB_dut2()
{
	...
	case 0x0001:
	{
		...
		dut2.g_dac_data_buf[1] = 0x58;	//Data L
		dut2.g_dac_data_buf[2] = 0x02;	//Data H
		dut2.g_dac_data_buf[3] = 0x1c;	//Data L
		dut2.g_dac_data_buf[4] = 0x02;	//Data H
		dut2.g_dac_data_buf[5] = 0x94;	//Data L
		dut2.g_dac_data_buf[6] = 0x02;	//Data H
