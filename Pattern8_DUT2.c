...
u8 _by_Pattern8_dut2()
{
	...
	case 0x0001:
	{
		...
		dut2.g_dac_data_buf[1] = 0xdc;	//Data L
		dut2.g_dac_data_buf[2] = 0x05;	//Data H
		dut2.g_dac_data_buf[3] = 0xa0;	//Data L
		dut2.g_dac_data_buf[4] = 0x05;	//Data H
		dut2.g_dac_data_buf[5] = 0x18;	//Data L
		dut2.g_dac_data_buf[6] = 0x06;	//Data H
