...
u8 _ccdet_calibration_dut0()
{
	...
	case ccdet_process_doing:
	{
		...
		{
	       dut0.g_pattern_smbus_control_buf[1] = smbus_cmd_type_writemem;
		   dut0.g_pattern_smbus_control_buf[2] = 0xa2;
		...
		{
	       dut0.g_pattern_smbus_control_buf[1] = smbus_cmd_type_writemem;
		   dut0.g_pattern_smbus_control_buf[2] = 0xa3;
		   dut0.g_pattern_smbus_control_buf[3] = 0xc1;
		   dut0.g_pattern_smbus_control_buf[4] = 0x01;
		   dut0.g_pattern_smbus_control_buf[5] = 0x06;
		...
		{
	       dut0.g_pattern_smbus_control_buf[1] = smbus_cmd_type_writemem;
		   dut0.g_pattern_smbus_control_buf[2] = 0xa0;
		   dut0.g_pattern_smbus_control_buf[3] = 0xc1;
		   dut0.g_pattern_smbus_control_buf[4] = 0x01;
		   dut0.g_pattern_smbus_control_buf[5] = dut0.g_ccdet_voltage_sel;
		...
		case 0x0006:
		{
			dut0.g_calibrate_signbit = 0x00;
			dut0.g_calibration_offset = 0x00;

			//write to phy 0x109/0x10a/0x10b/0x10c with default data
			dut0.g_pattern_smbus_control_buf[1] = smbus_cmd_type_writephy;
			dut0.g_pattern_smbus_control_buf[2] = dut0.g_ccdet_phy_calibration_addr_buf[0];
			dut0.g_pattern_smbus_control_buf[3] = dut0.g_ccdet_phy_calibration_addr_buf[1];
			dut0.g_pattern_smbus_control_buf[4] = 0x01;
			dut0.g_pattern_smbus_control_buf[5] = dut0.g_ccdet_calibration_data_buf[0];
			dut0.g_pattern_smbus_control_buf[6] = dut0.g_ccdet_calibration_data_buf[1];
			...
			//xil_printf("dut0_pattern5_write_0x109/0x10a/0x10b/0x10c_default_dataL= %x\r\n",dut0.g_ccdet_calibration_data_buf[0]);
			//xil_printf("dut0_pattern5_write_0x109/0x10a/0x10b/0x10c_default_dataH= %x\r\n",dut0.g_ccdet_calibration_data_buf[1]);
			//xil_printf("dut0.g_pattern_step = %x\r\n",dut0.g_pattern_step);
		    break;
		}
		...
		case 0x0007:
		{
			...
			dut0.g_pattern_smbus_control_buf[2] = 0xa9;
			dut0.g_pattern_smbus_control_buf[3] = 0xc1;
			dut0.g_pattern_smbus_control_buf[4] = 0x01;
			...
			else
			{
				...
				if(((dut0.g_pattern_smbus_control_buf[10] >> dut0.g_ccdet_ana_result_bit) & 0x01) == 1)
				{
		...
		case 0x0008:
		{
			...
			{
				if((dut0.g_calibration_offset >=0) && (dut0.g_calibration_offset <= 7))
				{
					if((dut0.g_ccdet_phy_calibration_bit >= 0) && (dut0.g_ccdet_phy_calibration_bit < 2))
					{
						dut0.g_pattern_smbus_control_buf[5] = (dut0.g_ccdet_calibration_data_buf[0]+(dut0.g_calibration_offset<<4*dut0.g_ccdet_phy_calibration_bit));
						dut0.g_pattern_smbus_control_buf[6] = dut0.g_ccdet_calibration_data_buf[1];
					}
					else if((dut0.g_ccdet_phy_calibration_bit >= 2) && (dut0.g_ccdet_phy_calibration_bit < 4))
					{
						dut0.g_pattern_smbus_control_buf[5] = dut0.g_ccdet_calibration_data_buf[0];
						dut0.g_pattern_smbus_control_buf[6] = (dut0.g_ccdet_calibration_data_buf[1]+(dut0.g_calibration_offset<<4*(dut0.g_ccdet_phy_calibration_bit-2)));
					}
				    //xil_printf("\r\ndut0.g_ccdet_calibration_data_buf[0] =%x\r\n", dut0.g_ccdet_calibration_data_buf[0]);
			...
			{
				if((dut0.g_calibration_offset >=0) && (dut0.g_calibration_offset <= 8))
				{
					if((dut0.g_ccdet_phy_calibration_bit >= 0) && (dut0.g_ccdet_phy_calibration_bit < 2))
					{
						dut0.g_pattern_smbus_control_buf[5] = (dut0.g_ccdet_calibration_data_buf[0]-(dut0.g_calibration_offset<<(4*dut0.g_ccdet_phy_calibration_bit)));
			...
			//xil_printf("dut0.g_calibration_offset =%x\r\n", dut0.g_calibration_offset);
			//xil_printf("dut0.g_pattern_step = %x\r\n",dut0.g_pattern_step);
			//xil_printf("dut0_pattern5_cc_write_to_0x109/a/b/c\r\n");
			break;
		}
			...
			else
			{
				if(((dut0.g_pattern_smbus_control_buf[10] >> dut0.g_ccdet_ana_result_bit) & 0x01) == 1)
				{
					if(dut0.g_calibrate_signbit == 0)
					{
						...
						else if((dut0.g_calibration_offset == 7) && (dut0.g_ccdet_retest_signbit == 0))
						{
							dut0.g_ccdet_retest_signbit = lower_voltage_retest;
							dut0.g_dac_data_buf[1] = dut0.g_dac_data_buf[3];
							dut0.g_dac_data_buf[2] = dut0.g_dac_data_buf[4];
							dut0.g_pattern_step = 0;
						}
						else
						{
			   ...
			   else if(((dut0.g_pattern_smbus_control_buf[10] >> dut0.g_ccdet_ana_result_bit) & 0x01) == 0)
			   {
				   if(dut0.g_calibrate_signbit == 1)
				   {
					   ...
					   else if((dut0.g_calibration_offset == 8)&& (dut0.g_ccdet_retest_signbit == 0))
					   {
						   dut0.g_ccdet_retest_signbit = higer_voltage_retest;
						   dut0.g_dac_data_buf[1] = dut0.g_dac_data_buf[5];
						   dut0.g_dac_data_buf[2] = dut0.g_dac_data_buf[6];
						   dut0.g_pattern_step = 0;
					   }
					   else
					   {
		...
		case 0x000a:
		{
			...
			{
				if(dut0.g_ccdet_retest_signbit == 0)
				{
					dut0.g_ccdet_calibration_data_buf[2] = dut0.g_pattern_smbus_control_buf[10];
					dut0.g_ccdet_calibration_data_buf[3] = dut0.g_pattern_smbus_control_buf[11];
				}

				if(dut0.g_ccdet_retest_signbit == lower_voltage_retest)
				{
					if((dut0.g_ccdet_phy_calibration_bit >= 0) && (dut0.g_ccdet_phy_calibration_bit < 2))
					{
						//dut0.g_ccdet_calibration_data_buf[2] = dut0.g_pattern_smbus_control_buf[10]|(0x0f<<(4*dut0.g_ccdet_phy_calibration_bit));
						//dut0.g_ccdet_calibration_data_buf[3] = dut0.g_pattern_smbus_control_buf[11];
						dut0.g_ccdet_calibration_data_buf[2] = dut0.g_pattern_smbus_control_buf[10];
						dut0.g_ccdet_calibration_data_buf[3] = dut0.g_pattern_smbus_control_buf[11];
					}
					if((dut0.g_ccdet_phy_calibration_bit >= 2) && (dut0.g_ccdet_phy_calibration_bit < 4))
					{
						//dut0.g_ccdet_calibration_data_buf[2] = dut0.g_pattern_smbus_control_buf[10];
						//dut0.g_ccdet_calibration_data_buf[3] = dut0.g_pattern_smbus_control_buf[11]|(0x0f<<(4*(dut0.g_ccdet_phy_calibration_bit-2)));
						dut0.g_ccdet_calibration_data_buf[2] = dut0.g_pattern_smbus_control_buf[10];
						dut0.g_ccdet_calibration_data_buf[3] = dut0.g_pattern_smbus_control_buf[11];
					}
				}

				if(dut0.g_ccdet_retest_signbit == higer_voltage_retest)
				{
					if((dut0.g_ccdet_phy_calibration_bit >= 0) && (dut0.g_ccdet_phy_calibration_bit < 2))
					{
						//dut0.g_ccdet_calibration_data_buf[2] = dut0.g_pattern_smbus_control_buf[10]& ~(0x0f<<(4*dut0.g_ccdet_phy_calibration_bit));
					...
					//xil_printf("dut0.g_ccdet_retest_signbit =%x\r\n", dut0.g_ccdet_retest_signbit);
					//xil_printf("dut0.g_ccdet_phy_calibration_bit =%x\r\n", dut0.g_ccdet_phy_calibration_bit);
				...
				dut0.g_ccdet_process_bit = ccdet_process_done_pass;
				dut0.g_pattern_smbus_control_buf[0] = smbus_road_waiting;
				dut0.g_pattern_step = 0;
			}
			//xil_printf("dut0.g_pattern_step = %x\r\n",dut0.g_pattern_step);
			//xil_printf("dut0_pattern2_read_cc_calibration_data_save_to_temp_efuse\r\n\r\n");
			break;
		}
	    }
		break;
